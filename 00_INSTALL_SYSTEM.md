...
> Предполагается, что пользоваться редактором nano ты уже умеешь. Если нет - читай Part 7 на странице "[настройке системы](https://github.com/codesshaman/sber_devops_d01_linux-master/blob/main/02_SYSTEM_SETTING.md "Настройка системы")".
