...
Теперь мы можем выключать виртуальную машину командой ``sudo shutdown now`` и закреплять достигнутый результат, сохранив снимок состояния системы, сделав экспорт и загрузив результаты нашего труда, например, в облако. Об этом [следующий гайд](https://releases.ubuntu.com/focal/ "скачать Ubuntu 20.04").