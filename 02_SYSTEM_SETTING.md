...
В общем, хэппи енд. Если в новой десктопной версии бубунты я так и не смог запустить терминал (да, стандартный терминал, пришлось загрузить сторонний!) то в серверной убунте нужно удалить сервис синхронизации времени, чтобы заработала синхронизация времени. Canonical, вы непредсказуемые ребята, спасибо за доставленную радость!
